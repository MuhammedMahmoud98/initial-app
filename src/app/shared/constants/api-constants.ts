...
export const API_CONSTANTS = {
  loginAPI: `${environment.host}/v3.1/public/auth`,
  ...
  REFRESH_TOKEN: `${environment.host}/v3.1/public/auth/refresh_token`,
  VALIDATE_TOKEN: `${environment.host}/v3.1/public/auth/validate`,
  // LOCATIONS
